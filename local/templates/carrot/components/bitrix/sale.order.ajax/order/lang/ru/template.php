...
$MESS['SOA_TEMPL_ORDER_SUC1'] = "Менеджер свяжется с Вами в ближайшее время для уточнения деталей.";
...
$MESS['SOA_ORDER_DELIVERY_METHOD'] = "Способ доставки";
$MESS['SALE_SADC_TRANSIT_APPROXIMATE'] = 'Примерный срок доставки';
?>