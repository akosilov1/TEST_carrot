...
else
{
		...
		<div id="order_form_id">
			...
			<div id="delay_none" style="display:block">
				...
				<div id="order_props" style="display:<?=$display?>">
					...
					<? include($_SERVER["DOCUMENT_ROOT"].$templateFolder."/basket_props_new.php");?>
	...
	<script type="text/javascript">
        ...
        function minusBasket(t) {
            var input = $(t).parents('.amount').find('input');
        ...
        function addGiftBasket(id) {
            var need = $('#gift_check').attr('data-need');
            if (need == 'N')
            {
                need = 'Y';
            }
