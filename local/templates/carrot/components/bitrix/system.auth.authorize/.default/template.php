...
<div class="bx-auth col-md-4 offset-4">
<?if($arResult["AUTH_SERVICES"]):?>
	<div class="bx-auth-title"><?echo GetMessage("AUTH_TITLE")?></div>
<?endif?>
    <h4 class="bx-auth-note"><?=GetMessage("AUTH_PLEASE_AUTH")?></h4>
<br>
...
<?endif?>
			<tr>
				<td></td>
				<td class="authorize-submit-cell text-center"><input type="submit" class="carrot-btn" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" /></td>
			</tr>
		</table>
