		...
		<div class="main-profile-block-shown" id="user_div_reg">
			...
			if (!in_array(LANGUAGE_ID,array('ru', 'ua')))
			{
				...
				<div class="form-group row">
					<label class="main-profile-form-label col-sm-2 col-form-label" for="main-profile-title"><?=Loc::getMessage('main_profile_title')?></label>
					<div class="col-sm-10">
			...
			?>
			<div class="form-group row">
				<label class="main-profile-form-label col-sm-2 col-form-label" for="main-profile-name"><?=Loc::getMessage('NAME')?></label>
				<div class="col-sm-10">
					<input class="form-control" type="text" name="NAME" maxlength="50" id="main-profile-name" value="<?=$arResult["arUser"]["NAME"]?>" />
				</div>
			</div>
			<div class="form-group row">
				<label class="main-profile-form-label col-sm-2 col-form-label" for="main-profile-last-name"><?=Loc::getMessage('LAST_NAME')?></label>
				<div class="col-sm-10">
					<input class="form-control" type="text" name="LAST_NAME" maxlength="50" id="main-profile-last-name" value="<?=$arResult["arUser"]["LAST_NAME"]?>" />
				</div>
			</div>
			<div class="form-group row">
				<label class="main-profile-form-label col-sm-2 col-form-label" for="main-profile-second-name"><?=Loc::getMessage('SECOND_NAME')?></label>
				<div class="col-sm-10">
			...
			<div class="form-group row">
				<label class="main-profile-form-label col-sm-2 col-form-label" for="main-profile-email"><?=Loc::getMessage('EMAIL')?></label>
				<div class="col-sm-10">
			...
			if($arResult["arUser"]["EXTERNAL_AUTH_ID"] == '')
			{
				...
				<div class="form-group row">
					<label class="main-profile-form-label col-sm-2 col-form-label" for="main-profile-password"><?=Loc::getMessage('NEW_PASSWORD_REQ')?></label>
					<div class="col-sm-10">
				...
				<div class="form-group row">
					<label class="main-profile-form-label main-profile-password col-sm-2 col-form-label" for="main-profile-password-confirm">
