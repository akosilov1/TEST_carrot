...
//$this->addExternalCss($templateFolder."/jquery.fancybox.css");
//$this->addExternalJs($templateFolder."/jquery.fancybox.min.js");
?>
		...
		<?if($arParams["DISPLAY_PICTURE"]!="N"):?>
			...
			<?elseif ($arItem["SLIDER"]):?>
				<div class="bx-newslist-img">
					<a href="<?=$arItem["DETAIL_PICTURE"]["SRC"]?>" data-fancybox  rel="gallery">
