...
?>
<div id="yur-register" class="bx-auth-reg">
...
<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
	...
	{
		case "PASSWORD":
			?><input size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" title="Пароль должен быть не менее 6 символов длиной" autocomplete="off" class="form-control bx-auth-input" />
...
<?
		...
		default:
			...
			<input class="form-control" size="30" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" 
				<?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y") echo "required";?>
			/>
